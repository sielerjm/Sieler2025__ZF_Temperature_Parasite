...
alpha.stats[[tmp.resSubSection]][["TEMP"]][["GLM.Table"]] <-
  ...
  gt::tab_header(
    title = "GLM Results",
    subtitle = "glm(Alpha.Score ~ Temperature); Exposed fish"
  )
...
alpha.stats[[tmp.resSubSection]][["TEMP"]][["ANOVA.Table"]] <-
  ...
  gt::tab_header(
    title = "ANOVA of GLM",
    subtitle = "ANOVA(GLM(Alpha.Score ~ Temperature), type = 2); Exposed fish"
  )
...
alpha.stats[[tmp.resSubSection]][["TEMP"]][["Tukey.Table"]] <-
  ...
  gt::tab_header(
    ...
    subtitle = "Tukey(Alpha.Score ~ Temperature); Exposed fish"
  )
...
beta.stats[[tmp.resSubSection]][["TEMP"]][["CAP.ADONIS.Table"]] <-
  ...
  gt::tab_header(
    title = "ADONIS2",
    subtitle = "adonis2(Beta Distance ~ Temperature); Exposed fish"
  )
...
beta.stats[[tmp.resSubSection]][["TEMP"]][["HoD.Tukey.Table"]] <-
  ...
  gt::tab_header(
    ...
    subtitle = "Tukey(Beta Disperson ~ Temperature); Exposed fish"
  )
...
alpha.stats[[tmp.resSubSection]][["TEMP:DPE"]][["GLM.Table"]] <-
  ...
  gt::tab_header(
    title = "GLM Results",
    subtitle = "glm(Alpha.Score ~ Temperature*DPE); Exposed fish"
  )
...
beta.stats[[tmp.resSubSection]][["TEMP:DPE"]][["CAP.ADONIS.Table"]] <-
  ...
  gt::tab_header(
    title = "ADONIS2",
    subtitle = "adonis2(Beta Distance ~ Temperature*DPE); Exposed fish"
  )
...
beta.stats[[tmp.resSubSection]][["TEMP:DPE"]][["HoD.Tukey.Table"]] <-
  ...
  gt::tab_header(
    title = "Tukey: Homogeneity of Dispersion",
    subtitle = "Tukey(Beta Disperson ~ Temperature*DPE); Exposed fish"
  )
